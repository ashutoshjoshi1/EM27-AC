...
class ACControlWidget(QWidget):
    """Qt widget for controlling an air conditioner via ``ACService``."""
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        # Status box for reporting current readings
    ...
    def _on_error(self, msg: str) -> None:
        # Display error in the status label for better visibility
    ...
    def _on_connected(self, ok: bool) -> None:
        ...
        # Update the status label to reflect connection state
